...
a. Generate 10 “experiments” with 5 observations each. Compute the slopes and the intercepts using the formula of equation 3.4, check that the values are the same as given by the `lm()` function in R , and plot the 10 different lines. Also plot in bold the “true” line.

b. Now repeat 10 experiments, but with 20 observations each. Plot the 10 different lines. What do you conclude?

c. For each 5 and 20 observations, use the formula of equations 3.8 to compute the SE for the slope. 
...
## Solution 1(b)
### Visualize for 20 observations from 10 experiments
