...
```{r, echo=T, include=T}
train.size = round(dim(College)[1] *.8) # begin with setting the size of train set
```
...
## (b) Principal Component Regression (PCR) - Prompt
...
## (c) Partial Least Square Regression (PLSR) - Prompt
