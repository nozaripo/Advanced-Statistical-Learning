...
ggplot(RSS.df.noCentering, aes(x=beta0, y=beta1, z=RSS)) +
  ...
  geom_point(aes(x=Coefficients.noCentering[[1]], y=Coefficients.noCentering[[2]]), col="red") +
  theme_bw()
...
ggplot(RSS.df.Centering, aes(x=beta0, y=beta1, z=RSS)) +
  geom_contour(bins=100) + 
  geom_point(aes(x=Coefficients.Centering[[1]], y=Coefficients.Centering[[2]]), col="red") +
  theme_bw()
